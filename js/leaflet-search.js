...
L.Control.Search = L.Control.extend({
	...
	options: {
		...
		autoCollapse: false,			//collapse search control after submit(on button or on tips if enabled tip AutoSubmit)
		autoCollapseTime: 800,			//delay for autoclosing alert and collapse after blur
		textErr: 'Location not found',	//error message
		textCancel: 'Cancel',		    //title in cancel button		
		textPlaceholder: 'Search for your business...',   //placeholder value			
		position: 'topleft',
